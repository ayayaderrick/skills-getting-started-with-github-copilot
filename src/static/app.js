        ...
        const participantsHTML = details.participants && details.participants.length
          ? `
            ...
            <ul class="participants-list" data-activity="${name}">
              ${details.participants.map(p => `<li><span class="participant-email">${p}</span><button type="button" class="remove-participant" data-email="${p}" title="Remove participant">✖</button></li>`).join('')}
            </ul>
          `
